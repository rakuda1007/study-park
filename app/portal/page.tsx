...
const FEATURES = [
  {
    ...
    body: (
      <>
        Study Park の教材も、テキストや問題集などのその他教材も、科目ごとの学習計画としてまとめて管理できます。
        今週の予定を一覧で確認し、進捗を記録。期限が近い項目や遅れている計画もひと目でわかるので、「何を・いつまでに・どこまで」が常にクリアです。
        よく使う教材を登録しておけば、次回からサッと計画に追加できます。
      </>
    ),
    bullets: [
      "科目・期間・教材をセットにした学習計画を、週単位で一覧表示",
      "進捗％を記録し、期限近・遅れをアラートで見逃さない",
      "Study Park 教材と外部教材を同じ計画で管理、よく使う項目で入力も高速",
    ],
    image: {
      src: "/portal10.jpg",
  ...
  },
  {
    ...
    body: (
      <>
        教科書や参考書を見ていて「覚えたい」「ここが出そう」と思ったその瞬間に、迷わず問題を登録できます。
        科目や単元ごとに自動で整理されるので、問題が増えても管理に困りません。
        できた教材は URL や招待コードで簡単にシェア。友達同士でクイズ感覚で競ったり、ご家庭で親製テストを作ったり、塾や教室から生徒へ一斉配信したりと、作った学びをそのまま届けられます。
      </>
    ),
    bullets: [
      "直感的な操作で、重要問題をいつでも簡単にスピード登録",
      "科目・単元ごとに分類され、大量の問題もスッキリ整理",
      "友達・家庭・教室まで、URLやコードで手軽に共有・配信",
    ],
    image: {
      src: "/portal11.jpg",
      alt: "海辺でジャンプする仲間たち",
